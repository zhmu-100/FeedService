...
@Serializable data class RemoveReactionRequest(val postId: String, val userId: String)

@Serializable data class PaginationRequest(val page: Int = 1, val pageSize: Int = 20)

@Serializable data class ListPostsResponse(val posts: List<Post>)

@Serializable data class ListCommentsResponse(val comments: List<PostComment>)
